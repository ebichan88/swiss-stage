...
/** /api/v1/shared/** のIPベースレート制限(13_security_design.md §5)。 上限を小さく上書きした専用コンテキストで検証する。 */
@TestPropertySource(
    properties = {"app.rate-limit.shared.capacity=3", "app.rate-limit.shared.refill-per-minute=1"})
