...
public class GroupController {
  ...
  public ApiSuccess<GroupDto> create(
    ...
    return success(groupService.create(PathIds.tournamentId(tournamentId), user.sub(), request));
  }
  ...
  public ResponseEntity<Void> delete(
      ...
      @PathVariable("tournamentId") String tournamentId,
      @PathVariable("groupId") String groupId) {
    groupService.delete(PathIds.tournamentId(tournamentId), PathIds.groupId(groupId), user.sub());
