...
/** 例外の一元処理(06_error_handling_design.md §3)。 内部情報(スタックトレース・キー構造)と個人情報(氏名・所属)はレスポンス・ログに出さない。 */
...
public class GlobalExceptionHandler {
  ...
  public ResponseEntity<ApiError> handleUploadSize(MaxUploadSizeExceededException e) {
    ...
    return respond(ErrorCode.CSV_INVALID_FORMAT, "ファイルサイズが上限(1MB)を超えています", List.of());
  }
