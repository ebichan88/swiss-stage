...
/**
 * 共有ページ(S10)向けの大会集約DTO(GET /api/v1/shared/{token})。 共有トークン経由のレスポンスには shareToken・ownerSub
 * を含めない(13_security_design.md §6)。
 * competitionType=INDIVIDUALではrounds/standingsが非null・teamRounds/teamStandingsはnull、 TEAMではその逆になる。
 */
