...
/**
 * 参加者。organization / rank は任意(null許容)。 groupId
 * は必須。参加者は常にいずれかのグループに帰属する(05_swiss_pairing_algorithm.md §2.4)。
 */
public record Participant(
  ...
  public Participant withdraw() {
    return new Participant(
        id, name, organization, rank, entryOrder, ParticipantStatus.WITHDRAWN, groupId);
  }
